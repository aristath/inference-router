...
- `INFERENCE_ROUTER_MAX_INSTANCES_PER_MODEL` — maximum concurrent backend processes per model. Defaults to VRAM-limited scale-out; set it to cap replica processes while requests are busy.
